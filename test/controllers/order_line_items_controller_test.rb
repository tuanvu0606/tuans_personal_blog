...
class OrderLineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_line_item" do
    assert_difference('OrderLineItem.count') do
      post order_line_items_url, params: { order_line_item: { inventory_item_id: @order_line_item.inventory_item_id, order_id: @order_line_item.order_id, order_item_qty: @order_line_item.order_item_qty, order_line_item_price: @order_line_item.order_line_item_price, total_price: @order_line_item.total_price } }
    end
  ...
  test "should update order_line_item" do
    patch order_line_item_url(@order_line_item), params: { order_line_item: { inventory_item_id: @order_line_item.inventory_item_id, order_id: @order_line_item.order_id, order_item_qty: @order_line_item.order_item_qty, order_line_item_price: @order_line_item.order_line_item_price, total_price: @order_line_item.total_price } }
